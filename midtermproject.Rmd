...
# packages = c("dplyr", "tidytext", "stringr", "wordcloud2","tidyverse",'knitr','kableExtra','NLP','plotly', "ggplot2",'readr','data.table','reshape2','wordcloud','tidyr','scales','jiebaR','sentimentr','htmltools',"ggraph", "igraph", "reshape2", "widyr","ggplot","gtools")
...
### 新增中山正面及負面字典
>>>>>>> 267cf6204ee81e5eb6ed7259503b40b5c0e0396c
```{r}
