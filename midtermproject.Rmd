...
---
## 一、動機和分析目的
- 近期中山大學校方與高雄大學校方積極在討論併校的議題，因為我們有一股中山魂，因此想瞭解學校的議題，即使快要畢業，但是併校此議題對於身為中山大學學生的我們影響依舊很大，而且會影響學弟妹的未來，所以想做關於併校議題的分析。我們透過分析得知網路上各種來源(ptt、Dcard的高大板、中山板、考試板)的看法，進而歸納出結論。
...
- 我們可以看到分成6群，第一、二群很接近，第三群則是跟新鮮(人)、調查、企業上與工作相關的，第四群是校董與三間學校，第五群是關於中山與高醫，第六群是選系與基礎科學及國北教
...
- 1的話因為主題跟校董名有關，因此會出現校董這種特別字；3的話因為是跟鄭英耀與討論有關，因此會出現四屆、談過這種特別字。2跟4主題不明顯因此無法解釋
